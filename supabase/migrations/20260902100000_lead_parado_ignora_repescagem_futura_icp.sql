-- "Repescagem futura de ICP" (leads.oportunidade_futura = true, dentro do
-- nível Oportunidades) nunca conta como parado — o lead fica ali de
-- propósito esperando ser retomado depois, sem precisar de reunião nem
-- de próximo contato marcado pra isso ser normal.
