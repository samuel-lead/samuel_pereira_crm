-- A org "Veend" foi criada depois da migration
...
-- estágios (0 a 7), enquanto o resto do sistema já usa 9 (0 a 8). Aplica
-- a mesma correção que as outras orgs já tiveram, só que pra essa aqui.

do $$
declare
  v_org_id uuid := '1cc080fd-055d-4f8b-950c-7537cf4f0064';
begin
