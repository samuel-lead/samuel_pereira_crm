-- Reunião marcada só isenta o lead de contar como "parado" ENQUANTO a
-- data ainda não chegou — assim que a data passa e ninguém atualizou o
-- resultado (reunião "esquecida"), volta a contar como parado, igual
-- já acontece com o próximo contato marcado.
