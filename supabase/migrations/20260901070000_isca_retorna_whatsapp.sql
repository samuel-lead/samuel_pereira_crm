-- A função devolve também o WhatsApp de contato e a mensagem
-- pré-preenchida (quando a isca é "só cadastro") — o componente da
-- página pública usa isso pra montar o botão "Falar agora com nossa
-- equipe" na hora, sem precisar de outra consulta.
