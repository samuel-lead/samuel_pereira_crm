-- Público imobiliário fala "Visita", não "Reunião" — as duas notificações
-- que citam esse encontro (reunião de hoje, reunião cancelada) precisam
-- olhar o público da org do usuário antes de montar a mensagem.
