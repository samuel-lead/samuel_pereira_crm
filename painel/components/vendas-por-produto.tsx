...
export function VendasPorProduto({ dados, periodo }: { dados: VendaPorProduto[]; periodo: string }) {
  ...
  return (
    <section className="rounded-xl border border-neutral-200 bg-white p-4 shadow-sm">
      <h2 className="mb-1 text-sm font-semibold text-neutral-800">
        Produtos mais vendidos — {periodo.toLowerCase()}
      </h2>
      <p className="mb-4 text-xs text-neutral-500">
        Cada produto vendido, com quantas vezes aconteceu e quanto faturou.
      </p>
      ...
      {dados.length === 0 ? (
        ...
        <div className="space-y-2">
          {dados.map((linha) => {
            ...
            return (
              <div key={linha.produto}>
                <div className="mb-1 flex items-center justify-between text-sm">
                  <span className="font-medium text-neutral-700">{linha.produto}</span>
