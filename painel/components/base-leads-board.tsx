...
const COLUNAS: { chave: MotivoBase; nome: string; cor: { header: string; borda: string; badge: string } }[] = [
  ...
  },
  {
    chave: "farming",
    nome: "Farming",
    cor: { header: "bg-emerald-50", borda: "border-emerald-200", badge: "bg-emerald-200 text-emerald-700" },
  },
];
                        ...
                        <div className="mt-1 flex flex-wrap items-center gap-1.5">
                          ...
                          {lead.telefone_e164 && (
                            <a
                              ...
                              className="flex shrink-0 items-center gap-1 rounded-full bg-green-700 px-3 py-1.5 text-white transition hover:bg-green-800"
                            >
                          ...
                          {lead.instagram && (
                            <a
                              ...
                              className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg text-white transition hover:opacity-90"
                            >
